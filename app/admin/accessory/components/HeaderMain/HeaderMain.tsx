...
import { FormAddAccessory } from "../FormAddAccessory/FormAddAccessory";
...
export  function HeaderMain(props:HeaderMainProps) {
  ...
  const [typeElemet, setTypeElement] = useState<"shirt"|"accessory"|"">();
  ...
  return (
    <div className="flex justify-between items-center">
        <h1 className="text-xl md:text-3xl font-semibold p-4">Administrar Acesorios</h1>
        ...
        <DialogContent className="sm:max-w-[825px]">
          <DialogHeader>
            <DialogTitle>Nuevo Acesorio</DialogTitle>
          </DialogHeader>
          {typeElemet === 'accessory' && <FormAddAccessory userId={userId} categoryIds={categoryId} closeDialog={closeDialogAndDropdown}/>}
