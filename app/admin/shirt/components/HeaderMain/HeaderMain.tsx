...
import { FormAddShirt } from "../FormAddShirt/FormAddShirt";
...
export  function HeaderMain(props:HeaderMainProps) {
  ...
  return (
    <div className="flex justify-between items-center">
      <h1 className="text-xl md:text-3xl font-semibold p-4">Administrar Camisas</h1>
      <Dialog open={openDialog} onOpenChange={setOpenDialog}>
        ...
        <DialogContent className="sm:max-w-[825px]">
          <DialogHeader>
            <DialogTitle>Nueva Camisa</DialogTitle>
          </DialogHeader>
          {typeElemet === 'shirt' && <FormAddShirt userId={userId} categoryIds={categoryId} closeDialog={closeDialogAndDropdown}/>}
