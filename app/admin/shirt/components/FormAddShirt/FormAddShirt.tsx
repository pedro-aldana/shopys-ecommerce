...
import { FormAddShirtProps } from './FormAddShirt.type';
import { formSchema } from "./FormAddShirt.form";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";
import { Checkbox } from "@/components/ui/checkbox";
import Image from "next/image";

export function FormAddShirt(props: FormAddShirtProps) {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      await axios.post("/api/shirt", values);
      toast({ title: "Camisa Publicada ✅" });
