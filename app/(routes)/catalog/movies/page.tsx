    ...
    return (
      <div>
          ...
          <div className="lg:w-1/2 p-4 text-center lg:text-left mx-12">
              <img src="/images/vikingos.jpg" alt="" className='rounded-md' />
          ...
          Descubre nuestro catalogo de Peliculas y obten increibles descuentos
          </p>
          <Button onClick={()=> router.push('https://drive.google.com/file/d/1rXVXiVku9Qhqgek0BaceYw8EVu8U2giL/view?usp=sharing')} className='items-center'>Ver Catalogo</Button>
          </div>
