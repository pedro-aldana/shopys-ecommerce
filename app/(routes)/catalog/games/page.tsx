    ...
    return (
      <div>
          ...
          <div className="lg:w-1/2 p-4 text-center lg:text-left mx-12">
              <img src="/images/god-war.jpg" alt="" className='rounded-md' />
          ...
          Descubre nuestro catalogo de Video Juegos y obten increibles descuentos
          </p>
          <Button onClick={()=> router.push('https://drive.google.com/file/d/1Kxj4gwDL9s4G2uigiICFLCT8Nlj8HGTm/view?usp=sharing')} className='items-center'>Ver Catalogo</Button>
          </div>
