...
export  function FeaturedProducts(props:FeaturedProductsProps) {
  ...
  return (
    <div className="max-w-6xl py-4 mx-auto sm:py-16 sm:px-24">
        <h3 className="px-6 text-2xl sm:pb-8 uppercase">Camisas mas vendidas</h3>
        <Carousel>
                         ...
                         <div className="p-1">
                             <Card className="py-4 border border-gray-200 shadow-none">
                                 <CardContent className="relative flex items-center justify-center px-6 py-2">
                                         <img src={shirt.image ? shirt.image : ""} />
                                         ...
                                         <div className="absolute w-full px-6 transition duration-200 opacity-0 group-hover:opacity-100 bottom-5">
                                             <div className="flex justify-center gap-x-6">
                                                 ...
                                                 <IconButton onClick={() => addShirt(shirt)} icon={<ShoppingCart size={20}/>} className="text-gray-600" />
                                             </div>
                                         </div>
                                 </CardContent>
